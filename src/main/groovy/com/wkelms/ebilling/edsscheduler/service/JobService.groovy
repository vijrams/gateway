...
public interface JobService {
	boolean scheduleCronJob(String jobName, Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression, String customClass)
	...
	def createJobExecutionEntry(def context, def duration, def status, def message)
	def getJobExecutionHistory(String jobName)
}
